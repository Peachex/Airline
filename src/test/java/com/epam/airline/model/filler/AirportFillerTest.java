...
public class AirportFillerTest {
    @Test
    public void fillAirportWithAirline() {
        ...
        AirportFiller filler = new AirportFiller();
        filler.fillAirportWithAirlines("data\\airlines.txt");

        List<Airline> actual = new ArrayList<>();
        for (int i = 0; i < Airport.getAirport().getSize(); i++) {
            actual.add(Airport.getAirport().getAirline(i));
        }
